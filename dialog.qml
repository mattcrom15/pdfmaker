...
Dialogs.BasicDialog {
    id: rootId
    dialogHeight: Dimensions.sizes.ultraLarge*5
    ...
    contentComponent: Component {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                // Third, show a blue button to the user to trigger the create action
                HighlightButtons.SquareTextHighlightButton {
                    ...
                    onClicked: {
                        ...
                        controller.create(textInputId.text, subTitleInputId.text)
